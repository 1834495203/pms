 ...
 * 推送公告信息
 * @author GLaDOS
 * @date 2023/5/13 18:30
 */
@Data
@Slf4j
@Component
@ServerEndpoint("/websocket/broadcast/{userId}")
public class BroadcastWebsocket {
    ...
    //  注：底下WebSocket是当前类名
    private static final CopyOnWriteArraySet<BroadcastWebsocket> webSockets = new CopyOnWriteArraySet<>();
    ...
    public CopyOnWriteArraySet<BroadcastWebsocket> getWebSockets(){
        return webSockets;
    }
    ...
    public void sendAllMessage(String message) {
        ...
        for(BroadcastWebsocket webSocket : webSockets) {
            try {
