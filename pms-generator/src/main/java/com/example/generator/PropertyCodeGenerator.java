...
public class PropertyCodeGenerator {
    ...
    // TODO 修改服务名以及数据表名
    private static final String SERVICE_NAME = "personnel";
    ...
    public static void main(String[] args) {
        ...
        //生成路径
        gc.setOutputDir(System.getProperty("user.dir") + "/pms-generator/src/main/java");
        gc.setAuthor("GLaDOS");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/pms_" + SERVICE_NAME
